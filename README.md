...
2) Package GALLOC into a Docker image and run it on a Docker container. To do this. please refer to the [Docker deployment guideline](Deployment_docker.txt);
